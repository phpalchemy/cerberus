 ...
 *
 * @method     \Alchemy\Component\Cerberus\Model\RolPermissionQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
 ...
 * @method     ChildPermission[]|ObjectCollection findByPrmId(int $prm_id) Return ChildPermission objects filtered by the prm_id column
 * @method     ChildPermission[]|ObjectCollection findByPrmName(string $prm_name) Return ChildPermission objects filtered by the prm_name column
 * @method     ChildPermission[]|ObjectCollection findByPrmCreateDate(string $prm_create_date) Return ChildPermission objects filtered by the prm_create_date column
 * @method     ChildPermission[]|ObjectCollection findByPrmUpdateDate(string $prm_update_date) Return ChildPermission objects filtered by the prm_update_date column
 * @method     ChildPermission[]|ObjectCollection findByPrmStatus(string $prm_status) Return ChildPermission objects filtered by the prm_status column
...
abstract class PermissionQuery extends ModelCriteria
{
    ...
    {
        return $this->addUsingAlias(PermissionTableMap::COL_PRM_ID, $key, Criteria::EQUAL);
    }
    ...
    {
        return $this->addUsingAlias(PermissionTableMap::COL_PRM_ID, $keys, Criteria::IN);
    }
    ...
    public function filterByPrmId($prmId = null, $comparison = null)
    {
        if (is_array($prmId)) {
            $useMinMax = false;
            if (isset($prmId['min'])) {
                $this->addUsingAlias(PermissionTableMap::COL_PRM_ID, $prmId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($prmId['max'])) {
                $this->addUsingAlias(PermissionTableMap::COL_PRM_ID, $prmId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_PRM_ID, $prmId, $comparison);
    }
    ...
    public function filterByPrmName($prmName = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_PRM_NAME, $prmName, $comparison);
    }
    ...
    public function filterByPrmCreateDate($prmCreateDate = null, $comparison = null)
    {
        if (is_array($prmCreateDate)) {
            ...
            if (isset($prmCreateDate['min'])) {
                $this->addUsingAlias(PermissionTableMap::COL_PRM_CREATE_DATE, $prmCreateDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($prmCreateDate['max'])) {
                $this->addUsingAlias(PermissionTableMap::COL_PRM_CREATE_DATE, $prmCreateDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_PRM_CREATE_DATE, $prmCreateDate, $comparison);
    }
    ...
    public function filterByPrmUpdateDate($prmUpdateDate = null, $comparison = null)
    {
        if (is_array($prmUpdateDate)) {
            ...
            if (isset($prmUpdateDate['min'])) {
                $this->addUsingAlias(PermissionTableMap::COL_PRM_UPDATE_DATE, $prmUpdateDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($prmUpdateDate['max'])) {
                $this->addUsingAlias(PermissionTableMap::COL_PRM_UPDATE_DATE, $prmUpdateDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_PRM_UPDATE_DATE, $prmUpdateDate, $comparison);
    }
    ...
    public function filterByPrmStatus($prmStatus = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(PermissionTableMap::COL_PRM_STATUS, $prmStatus, $comparison);
    }
    ...
    public function filterByRolPermission($rolPermission, $comparison = null)
    {
        if ($rolPermission instanceof \Alchemy\Component\Cerberus\Model\RolPermission) {
            return $this
                ->addUsingAlias(PermissionTableMap::COL_PRM_ID, $rolPermission->getPrmId(), $comparison);
    ...
    {
        if ($permission) {
            $this->addUsingAlias(PermissionTableMap::COL_PRM_ID, $permission->getPrmId(), Criteria::NOT_EQUAL);
        }
